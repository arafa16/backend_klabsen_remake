...
const getDatas = async(req, res) => {
    ...
    try {
        const result = await statusPerkawinanModel.findAll({
            order:[sortList]
        });
...
const getDataTable = async(req, res) => {
    ...
    try {
        const result = await statusPerkawinanModel.findAndCountAll({
            where:[
                queryObject,
...
const createData = async(req, res) => {
    ...
    try {
        await statusPerkawinanModel.create({
            name:name,
            code:code,
            is_active:is_active
        });
...
const updateData = async(req, res) => {
    ...
    const findData = await statusPerkawinanModel.findOne({
        where:{
            uuid:req.params.id
        }
    });
