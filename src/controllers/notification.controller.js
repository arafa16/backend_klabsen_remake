...
const createData = async(req, res) => {
    const {user_id, keterangan, tipe_notification_id, code, is_active} = req.body;

    try {
        await notificationModel.create({
            user_id:user_id,
            keterangan:keterangan,
            tipe_notification_id:tipe_notification_id,
            code:code,
            is_active:is_active
        });
...
const updateData = async(req, res) => {
    ...
    const findData = await notificationModel.findOne({
        where:{
            uuid:req.params.id
        }
    });
