...
const getDatas = async(req, res) => {
    ...
    try {
        const result = await tipePendapatanModel.findAll({
            order:[sortList]
        });
...
const getDataTable = async(req, res) => {
    ...
    try {
        const result = await tipePendapatanModel.findAndCountAll({
            where:[
                queryObject,
...
const createData = async(req, res) => {
    ...
    try {
        await tipePendapatanModel.create({
            name:name,
            code:code,
            is_active:is_active
        });
...
const updateData = async(req, res) => {
    ...
    const findData = await tipePendapatanModel.findOne({
        where:{
            uuid:req.params.id
        }
    });
